...
class PlayerMatchesRequestView extends StatelessWidget {
  const PlayerMatchesRequestView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(
        title: context.loc.matchGiocatore,
        background: AppColor.divivdercolor,
      ),
      body: StreamBuilder(
        stream: FirebaseMethod.matchInvitationGiocatoreCollectionStream(),
